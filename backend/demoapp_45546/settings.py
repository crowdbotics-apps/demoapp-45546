"""
Django settings for demoapp_45546 project.
...
ROOT_URLCONF = 'demoapp_45546.urls'
...
WSGI_APPLICATION = 'demoapp_45546.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp_45546 API",
    "DESCRIPTION": "API documentation for demoapp_45546 App",
    "VERSION": "v1",
}
